function eligiable() {
    ...
    if (incomereq > P1) {
        ...
        document.formval3.field11.value = (("N " + P1 + " at EMI " + "N " + emi1.toFixed(0)));
        document.formval3.field12.value = ("You are Eligible for a maximum loan of " + ("N " + incomereq + " at EMI " + "N " + emi2.toFixed(0)));
